...
## Layer
처음에 살펴보았던 5가지 요소들을 이용해 레이어를 구성한다. <br>
레이어가 구성되면 비로소 하나의 ggplot 이 그려지는것이다. <br>
...
```
linetype 을 점선으로, se 를 false 로 주어서 신뢰구간을 없앴다. <br>
5개의 요소들이 적절히 들어가 하나의 산점도를 생성하는 모습<br>
기타 다른 요소 geom 등은 다른 포스트에서 만나보자.
##
