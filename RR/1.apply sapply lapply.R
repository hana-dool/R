...
# tapply(벡터,요인,함수) : 요인(factor) 의 수준(level) 별로 특정벡터에 함수 명령어를 동시에 적용 
str(Cars93) 
# 차량 유형별(Type) 은 compeact/large/Midsize/small/sporty/van 의 수준으로 고성되어있다.
with(Cars93, tapply(MPG.highway, Type, mean)) #MPG 는 연비
