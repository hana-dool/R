...
function (dataframe,arg1,arg2) 이라는 함수와 아래 %>% 열로 합쳐진 구문은 같은 표현이다.
dataframe %>%  
function(arg1,ar2)  
...
## Select 
데이터 프레임에서 내가 원하는 column 만 선택하게 하는 구문. 
```{r}
...
```{r}
data %>%
  filter(class==1) # class 가 1반인 observation 만 보고 싶다는 뜻.
```
